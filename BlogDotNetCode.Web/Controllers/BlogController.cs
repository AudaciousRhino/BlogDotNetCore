...
namespace BlogDotNetCode.Web.Controllers
{
    ...
    public class BlogController : ControllerBase
    {
        ...
        [HttpGet]   // e.g. http://localhost:5000/api/Blog/?PageSize=33&Param2=blah (re 'GetAll([FromQuery] decoration/attribute ~ in signature below)
        ...
        public async Task<ActionResult<int>> Delete(int blogId)
        {
            ...
            // Check that the creator of the Blog for deletion is actually the logged-in User:
